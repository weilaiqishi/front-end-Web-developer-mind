...
(Garena)[ts类型](../../1html%26js/ts.md)

(顺丰)[深拷贝（不可遍历引用类型、可遍历引用类型、weakMap处理循环引用、BFS防爆栈）](../../1html&js/jscode/deepclone.js)

(顺丰)[数组拍平（主要要广度优先遍历/怎么处理）](../../1html%26js/jscode/array/flat.js)

(Garena)**原型链使用例子**

(Garena)**promise使用例子**

(顺丰)[ts有什么好处](../../1html%26js/ts.md)

(申通)[type与interface](../../1html%26js/ts.md)

(Garena)[ts抽象类](../../1html%26js/ts.md)
